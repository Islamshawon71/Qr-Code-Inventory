                ...
                <ul class="nav navbar-nav">
                  <!-- Messages: style can be found in dropdown.less-->
                    ...
                    <li class="dropdown notifications-menu">
                        <!-- Menu toggle button -->
                        <a href="stockin.php">
                            <i class="glyphicon glyphicon-list"></i> Stockin
                    ...
                    <li class="dropdown notifications-menu">
                        <!-- Menu toggle button -->
                        <a href="newsales.php">
                            <i class="glyphicon glyphicon-list"></i> New Sale
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php
                      $query=mysqli_query($con,"select COUNT(*) as count from product where prod_qty <=prod_qty ")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select prod_name from product where prod_qty<=prod_qty")or die(mysqli_error());
