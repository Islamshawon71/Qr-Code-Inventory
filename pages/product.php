            ...
            <div class="modal-body">
                ...
                <div id="app">
                    ...
                    <div class="preview-container">
                        <video style="    width: 100%;margin-bottom: 26px;" id="preview"></video>
                    </div>
                </div>
                ...
                <form class="form-horizontal" method="post" action="product_add.php" enctype='multipart/form-data'>
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="new_product_code" name="serial" placeholder="Product Code" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>
                            <input type="text" class="form-control" id="new_name" name="prod_name" placeholder="Product Name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3" for="price">Price</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="new_price" name="prod_price" placeholder="Product Price" required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="control-label col-lg-3" for="price">Quantity</label>
...
<script type="text/javascript" src="../dist/js/qr/app.js"></script>
<script>
    $(function () {
        $("#example1").DataTable();
        $('#example2').DataTable({
