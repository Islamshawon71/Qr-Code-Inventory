...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../dist/css/skins/_all-skins.min.css">
      ...
      <script type="text/javascript" src="../dist/js/qr/adapter.min.js"></script>
      <script type="text/javascript" src="../dist/js/qr/vue.min.js"></script>
      <script type="text/javascript" src="../dist/js/qr/instascan.min.js"></script>
                                    ...
                                    while($row=mysqli_fetch_array($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="product_delete.php?id=<?php echo $row['prod_id'];?>"  style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-blue"></i></a>
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" method="post" action="product_update.php" enctype='multipart/form-data'>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['product_code'];?>" readonly>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <select class="form-control select2" style="width: 100%;" name="category" required>
                                                                        ...
                                                                        while($rowc=mysqli_fetch_array($queryc)){
                                                                            ?>
                                                                            <option value="<?php echo $rowc['cat_id'];?>" <?php if($row['cat_id'] == $rowc['cat_id']){ echo  "selected"; }?>><?php echo $rowc['cat_name'];?></option>
                                                                        <?php }?>
                                                                    </select>
                                                                </div><!-- /.input group -->
                                                            </div><!-- /.form group -->
...
<form class="form-horizontal" method="post" action="product_add.php" enctype='multipart/form-data'>
			...
			<div class="col-lg-10 col-lg-offset-1">
				<div class="row">
					  ...
					  <div id="app"> 
							<div class="preview-container">
								<video style="margin-bottom: 26px; width:300px" id="preview"></video>
							</div>
						</div>
					  </div>
					  <div class="col-xs-6">
					   <div class="form-group"> 
					   <label class="control-label col-lg-4" for="price">Product Code</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="new_product_code" name="serial" placeholder="Sell ID" readonly>
                        </div>
                    </div>
					 <div class="form-group"> 
					 <label class="control-label col-lg-4" for="price">Phone No</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="new_product_code" name="serial" placeholder="Phone No" required>
                        </div>
                    </div>
				...
				<div class="col-lg-10 col-lg-offset-1">
				<h2 class='text-center'>Sell Information <hr></h2>
				 
					<table class='table' id='sell-info'>
					<thead>
						<tr>
...
<script type="text/javascript" src="../dist/js/qr/sell.app.js"></script>
<script>
//alert();
